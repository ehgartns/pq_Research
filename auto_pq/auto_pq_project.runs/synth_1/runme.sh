...
HD_PWD='C:/Users/ehgartns/Documents/summerReasearch2022/hw_pq/auto_pq/auto_pq_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log highest_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source highest_level.tcl
