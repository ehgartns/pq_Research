...
HD_PWD='C:/Users/ehgartns/Documents/summerReasearch2022/hw_pq/auto_pq/auto_pq_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log highest_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source highest_level.tcl -notrace
