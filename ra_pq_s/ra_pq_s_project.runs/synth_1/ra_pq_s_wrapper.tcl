...
synth_design -top ra_pq_s_wrapper -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef ra_pq_s_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file ra_pq_s_wrapper_utilization_synth.rpt -pb ra_pq_s_wrapper_utilization_synth.pb"
