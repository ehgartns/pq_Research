...
HD_PWD='C:/Users/ehgartns/Documents/summerReasearch2022/hw_pq/ra_pq_s/ra_pq_s_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ra_pq_s_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ra_pq_s_wrapper.tcl -notrace
